...
UPDATE cliente set nome = 'João Perereca', cep = '87654321', endereco = 'Rua do bobos', numero = 0, complemento = 'Ninguém podia dormir', bairro = 'Imaginário', cidade = 'Fantasma', estado = 'BA', rendaMensal = 0, limiteCredito = 0 where codigo = 1;  
